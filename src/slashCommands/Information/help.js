...
module.exports = {
  ...
  const embed = new MessageEmbed()
    ...
    let but2 = new MessageButton().setCustomId("music").setLabel("Music").setStyle("PRIMARY").setEmoji('911510602080456705')
  
    let but3 = new MessageButton().setCustomId("info").setLabel("Info").setStyle("PRIMARY").setEmoji('904365046308683866');
